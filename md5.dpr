{TODO 5 -cvery important: при запуске на сетевом диске вылетает с исключанием:
cannot create file.}

{ DONE -cvery important :ВНИМАНИЕ! при рекурсивной проверке контрольных сумм,
у каждого *.md5 файла должен быть свой базовый путь }

{ TODO : Впоследствии, указание рабочего каталога сделать через
...
//   аким образом, файл будет проверен, даже если он будет перемещен.
